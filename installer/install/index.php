            ...
            default: ?>
              ...
              <?php
                  ...
                  <form action="index.php?step=0" method="POST">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <input class="input" type="text" placeholder="enter random value" name="license" required>
                      </div>
                    </div>
                    <div class="field">
                      <label class="label">your envato username</label>
                      <div class="control">
                        <input class="input" type="text" placeholder="enter random value" name="client" required>
                      </div>
                    </div>
                    <div style='text-align: right;'>
              ...
              ?>
                ...
                <form action="#" id="admin-detail-form" method="POST">
                  <div class="field">
                    <label class="label">Admin Emailsss</label>
                    <div class="control">
